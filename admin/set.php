...
<div class="panel-body">
  <form onsubmit="return saveSetting(this)" method="post" class="form-horizontal" role="form">
	...
	<div class="form-group">
	  <label class="col-sm-2 control-label">隐藏用户IP</label>
	  <div class="col-sm-10"><select class="form-control" name="hide_user_ip" default="<?php echo $conf['hide_user_ip']?>"><option value="0">关闭</option><option value="1">开启（脱敏显示）</option></select><font color="green">开启后，在前端显示IP时会自动脱敏（如：192.168.1.***）</font></div>
	</div><br/>
	<div class="form-group">
...
<div class="panel-body">
  <form onsubmit="return saveSetting(this)" method="post" class="form-horizontal" role="form">
	...
	<div class="form-group">
	  <label class="col-sm-3 control-label">Linux Do OAuth2 登录</label>
	  <div class="col-sm-9">
	  <input type="hidden" name="login_linuxdo" value="0"/>
	  <label class="checkbox-inline"><input type="checkbox" name="login_linuxdo" value="1" <?php echo $conf['login_linuxdo']?'checked':null;?>> 启用 Linux Do 登录</label>
	  </div>
	</div><br/>
	<div class="form-group">
	  <label class="col-sm-3 control-label">Linux Do Client ID</label>
	  <div class="col-sm-9"><input type="text" name="login_linuxdo_clientid" value="<?php echo $conf['login_linuxdo_clientid']; ?>" class="form-control" placeholder="在 Linux Do 申请的 Client ID"/></div>
	</div><br/>
	<div class="form-group">
	  <label class="col-sm-3 control-label">Linux Do Client Secret</label>
	  <div class="col-sm-9"><input type="text" name="login_linuxdo_secret" value="<?php echo $conf['login_linuxdo_secret']; ?>" class="form-control" placeholder="在 Linux Do 申请的 Client Secret"/></div>
	</div><br/>
	<div class="form-group">
	  <div class="col-sm-offset-3 col-sm-9"><input type="submit" name="submit" value="修改" class="btn btn-primary form-control"/><br/>
	 </div>
