...
?>
                <div class="list-group-item list-group-item-info text-center">系统检测到你已安装过 OOCloud</div>
...
?>
            ...
            <footer class="footer">
            <pre><center>Powered by OOCloud</center></pre>
            </footer>
        </div>
    </div>
</div>
