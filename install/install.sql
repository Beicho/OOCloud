...
INSERT INTO `pre_config` VALUES ('title', 'OOCloud');
INSERT INTO `pre_config` VALUES ('keywords', 'OOCloud,网盘,外链,图床,文件分享');
INSERT INTO `pre_config` VALUES ('description', 'OOCloud 提供轻量的文件上传、外链分享与预览服务');
