    ...
    <div class="row">
      ...
      <div class="col-sm-9">
        ...
        <div style="min-height:50px;">
         ...
         <div id="upload_frame">
<?php if(isset($conf['disable_web_upload']) && $conf['disable_web_upload']==1){?>
         <div class="alert alert-warning">本站已关闭网页上传，请使用 API 上传（见“用户中心 → API Token”）。</div>
         <script>var forbid = true;</script>
<?php }elseif($conf['forcelogin']==1 && !$islogin2){?>
